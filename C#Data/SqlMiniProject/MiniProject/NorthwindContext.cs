...
namespace MiniProject
{
    public partial class NorthwindContext : DbContext
    {
        ...
        public virtual DbSet<Empage> Empages { get; set; }
        public virtual DbSet<Employee> Employees { get; set; }
        public virtual DbSet<EmployeeTerritory> EmployeeTerritories { get; set; }
        public virtual DbSet<Employeeage> Employeeages { get; set; }
        public virtual DbSet<Invoice> Invoices { get; set; }
        public virtual DbSet<Monthindex> Monthindices { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Empage>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("EMPAges");
                ...
                entity.Property(e => e.RetirementStatus)
                    .IsRequired()
                    .HasMaxLength(23)
                    .IsUnicode(false)
                    .HasColumnName("Retirement Status");
            });
            ...
            modelBuilder.Entity<Employeeage>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("employeeages");
            ...
            modelBuilder.Entity<Monthindex>(entity =>
            {
                entity.HasKey(e => e.MonthId)
                    .HasName("PK__monthind__9FA83F86EEC9FD2E");

                entity.ToTable("monthindex");
